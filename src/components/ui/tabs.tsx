  ...
  >(
    (
      ...
      <TabsPrimitive.Trigger
        ...
        className={cn(
          `inline-flex items-center w-full bg-transparent justify-center whitespace-nowrap rounded-lg p-3
           text-base ring-offset-white font-medium transition-all disabled:pointer-events-none disabled:opacity-50
           data-[state=active]:bg-accent data-[state=active]:text-white data-[state=active]:font-bold data-[state=active]:shadow-sm`,
          className
        )}
        {...props}
      />
